...
<script>
  window.location.replace("https://starkhack.netlify.app/writeup/hackmyvm/silentdev");
</script>
...
![img1](/img/Pasted%20image%2020251026184304.png)
...
![img2](/img/Pasted%20image%2020251026184555.png)
...
![img3](/img/Pasted%20image%2020251026184836.png)
...
![img4](/img/Pasted%20image%2020251026185155.png)
...
![img5](/img/Pasted%20image%2020251026185853.png)
...
![img6](/img/{77EBF70A-1AD8-4388-B847-2352DA5F991C}.png)
...
![img7](/img/{FC9089B9-42B0-41E7-A8E0-DA1AB0B315D7}.png)

![img8](/img/{F9959BE8-04F7-4ACA-B5D5-310686143167}.png)

En sentido de tecnologías no vemos nada en especial.

Bueno para probar vamos a subir una imagen y ver que sucede:

![img9](/img/{C2627CF3-0B6C-4143-886D-E36EBB3208E2}.png)
...
![img10](/img/{3007F2A9-D99A-4C7C-A34F-4EE4D85F83C7}.png)
...
![img11](/img/{C6FF9407-4C80-4632-9465-C0B83608DE45}.png)
...
![img12](/img/{DB272997-2AA6-4AA8-8D17-9FA8A3B9E0AC}.png)

![img13](/img/Pasted%20image%2020251026191338.png)

![img14](/img/Pasted%20image%2020251026191430.png)

![img15](/img/{CF2EA671-5399-41C4-854A-C092C03FC9D4}.png)
...
![img16](/img/Pasted%20image%2020251026191753.png)
...
![img17](/img/Pasted%20image%2020251026191954.png)
...
![img23](/img/Pasted%20image%2020251026194942.png)
...
![img24](/img/{66F4048E-240F-4B8F-9A6E-A61B1F91B6AE}.png)
...
![img25](/img/{0B133606-6E4C-4415-973E-2766AEBFB6BA}.png)
...
![img26](/img/Pasted%20image%2020251026195828.png)
...
![img27](/img/Pasted%20image%2020251026200427.png)
...
![img28](/img/Pasted%20image%2020251026200816.png)
...
![img29](/img/Pasted%20image%2020251026201418.png)
...
![img30](/img/Pasted%20image%2020251026201757.png)
...
![img31](/img/{80CDFC1A-C163-4653-8866-5C8DEA181400}.png)
...
![img34](/img/Pasted%20image%2020251026202758.png)

Por último exportamos `xterm`:
![img35](/img/Pasted%20image%2020251026202827.png)

Ya con esto podemos intentar ver con `sudo -l` que comandos podemos usar sin necesidad de pasarle contraseña:

![img36](/img/Pasted%20image%2020251026202957.png)
...
![img37](/img/{EECC81F8-22C4-48FA-92CA-F1C1145D7D44}.png)
...
![img38](/img/Pasted%20image%2020251026203358.png)
...
![img42](/img/Pasted%20image%2020251026204243.png)

Al parecer el comando no lo tenemos. Vamos a traernos el binario a nuestra máquina para poder verlo:

![img43](/img/{9ACA1B3A-2DB8-423D-A0D0-86A833BD4FE2}.png)

Ya con esto le damos permisos de ejecución:

![img44](/img/{7C02ACAF-101A-4EBA-9F68-52B8E43AA0EF}%201.png)
...
![img45](/img/{6C7BFDC8-93B6-4270-8A8F-1A6F0EFBAF8F}.png)
...
![img46](/img/{C69502AA-4EB4-4D48-9B8C-EA3257F2B39E}.png)
...
![img47](/img/{BA5B8E0D-260B-4154-BB30-6478FD64FE8E}.png)

!Perfecto ya estamos como root, con esto ya podemos ver la flag del usuario root:

![img48](/img/{1E5DF19B-2FD9-443A-B7C3-57F22F1B4310}.png)

Con esto tenemos terminada la máquina.

![img49](/img/{75D15725-A61A-46A5-B518-70391913AF43}.png)
